...
def cart_add(request, product_id):
    ...
    if request.headers.get('HX-Request'):
        ...
        return render(request, 'shop/partials/cart_item_added.html', {
            'product': product,
            'cart': cart
        })
...
def cart_remove(request, product_id):
    ...
    if request.headers.get('HX-Request'):
        return render(request, 'shop/partials/cart_updates.html', {
            'product': product,
            'cart': cart
        })
    return redirect('cart_detail')
...
def cart_update(request, product_id):
    ...
    try:
        ...
        if quantity <= 0:
            ...
            return render(request, 'shop/partials/cart_item_update_zero.html', {
                'product': product,
                'cart': cart
            })
    ...
    return render(request, 'shop/partials/cart_item_update.html', {
        'product': product,
