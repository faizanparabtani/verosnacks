...
def payment_process(request):
    ...
    if request.method == 'POST':
        ...
        tax = ((subtotal + shipping_cost) * Decimal(str(settings.ONTARIO_TAX_RATE))).quantize(Decimal('0.01'))
        ...
        try:
            ...
            messages.error(request, "There was an error connecting to Stripe. Please try again.")
